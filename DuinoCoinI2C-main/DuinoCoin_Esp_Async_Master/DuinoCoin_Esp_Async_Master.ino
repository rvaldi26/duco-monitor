...
const char* ssid          = "hola";         // Change this to your WiFi SSID
const char* password      = "lupalupa";         // Change this to your WiFi password
const char* ducouser      = "agam_sanjaya";   // Change this to your Duino-Coin username
